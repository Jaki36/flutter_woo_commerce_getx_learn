   ...
   return ListView(
      children: [
        ListTile(
          ...
          title: const TextWidget.body1("IconWidget.icon", color: Colors.blue,),
        ),
        ListTile(
          leading: IconWidget.image(AssetsImages.defaultPng),
          title: const TextWidget.body1("IconWidget.image", color: Colors.blue),
        ),
        ListTile(
          leading: IconWidget.svg(AssetsSvgs.cHomeSvg),
          title: const TextWidget.body1("IconWidget.svg", color: Colors.blue),
        ),
        ListTile(
          ...
          title: const TextWidget.body1("IconWidget.url", color: Colors.blue),
        ),
      ],
    );
  }
